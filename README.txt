...
I have added two screenshots as well that show the resulting nginx logs document structure in ES and a sample dashboard I constructed using an index pattern for that index.
